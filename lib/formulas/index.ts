...
import { FORMULA_REGISTRY as business_raise_percentage } from './business/raise-percentage';
...
import { FORMULA_REGISTRY as finance_apy } from './finance/apy';
import { FORMULA_REGISTRY as finance_auto_loan } from './finance/auto-loan';
import { FORMULA_REGISTRY as finance_balance_transfer } from './finance/balance-transfer';
import { FORMULA_REGISTRY as finance_budget } from './finance/budget';
import { FORMULA_REGISTRY as finance_cap_rate } from './finance/cap-rate';
...
import { FORMULA_REGISTRY as finance_debt_avalanche } from './finance/debt-avalanche';
import { FORMULA_REGISTRY as finance_debt_consolidation } from './finance/debt-consolidation';
import { FORMULA_REGISTRY as finance_debt_payoff } from './finance/debt-payoff';
import { FORMULA_REGISTRY as finance_debt_snowball } from './finance/debt-snowball';
...
import { FORMULA_REGISTRY as finance_retirement_withdrawal } from './finance/retirement-withdrawal';
import { FORMULA_REGISTRY as finance_roth_conversion } from './finance/roth-conversion';
import { FORMULA_REGISTRY as finance_rule_of_72 } from './finance/rule-of-72';
...
import { FORMULA_REGISTRY as math_permutation_combination } from './math/permutation-combination';
...
const formulaRegistry: Record<string, FormulaFunction> = {
  ...
  ...finance_debt_avalanche,
  ...finance_debt_consolidation,
  ...finance_debt_payoff,
  ...finance_debt_snowball,
  ...
  ...finance_retirement_withdrawal,
  ...finance_roth_conversion,
  ...finance_rule_of_72,
